        ...
        <header className="fv-app-page-header px-5 sm:px-8 py-5 shrink-0">
          <div className="max-w-6xl mx-auto flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex flex-col gap-1.5 shrink-0">
              <label className="text-[11px] font-semibold uppercase tracking-wide text-white/70" htmlFor="income-month">
                Month
              </label>
              <select
                id="income-month"
            ...
            <div className="px-5 sm:px-7 pt-6 pb-5 border-b border-border-subtle bg-linear-to-b from-mist/30 to-transparent">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <h2 className="font-display text-xl sm:text-2xl font-semibold text-void mt-0.5">Income records</h2>
            ...
            <div>
              {loading ? (
                <div className="flex flex-col items-center justify-center gap-3 px-6 py-16">
                  ...
                  <p className="text-sm text-ink-secondary">Loading income…</p>
                </div>
              ) : filtered.length === 0 ? (
      ...
      {showModal ? (
        ...
        >
          <div className="w-full max-w-md max-h-[min(90vh,640px)] overflow-y-auto rounded-2xl border border-lavender/40 bg-surface p-6 sm:p-7 shadow-(--shadow-fv-xl) ring-1 ring-forest/8">
            ...
            <h3 id="income-modal-title" className="font-display text-xl font-semibold text-void mt-1 mb-6">
              {editingTx ? "Edit income" : "Add income"}
            </h3>
