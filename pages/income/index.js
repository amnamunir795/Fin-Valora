...
export default function Income() {
  ...
  return (
    <div className="min-h-screen bg-mist flex">
      {/* Sidebar */}
      <div className="w-64 bg-surface shadow-xl border-r border-lavender/40">
        ...
        <div className="absolute bottom-6 left-6">
          <button onClick={logout} className="flex items-center px-4 py-3 text-void hover:bg-mist/30 hover:text-forest rounded-lg transition-all duration-200">
