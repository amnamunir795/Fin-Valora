...
import { logBudgetSaved } from "../../../lib/activityLogger";
    ...
    authenticateToken(req, res, async () => {
      try {
        ...
        if (existingBudget) {
          ...
          existingBudget.currency = currency || req.user.currency || DEFAULT_CURRENCY;
          ...
          const newBudget = new Budget({
            ...
            spendingLimit,
            savingGoal,
            currency: currency || req.user.currency || DEFAULT_CURRENCY,
            budgetMonth,
            budgetYear,
            currentSpent: 0,
            currentSaved: 0,
