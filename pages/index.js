              ...
              {user ? (
                <div className="space-y-4">
                  <p className="text-lg text-gray-700 mb-6">
                    ...
                    ! Ready to manage your finances in{" "}
                ...
                <div className="text-center py-8">
                  <svg
                    className="w-16 h-16 text-[#B5BFC8] mx-auto mb-4 opacity-50"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <div className="space-y-6">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
                ...
                <div className="space-y-3 border-t pt-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-[#B5BFC8]">
                      {getFormattedCurrency(user.currency)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
              <h3 className="font-bold text-gray-800 mb-4 flex items-center">
                <svg
                  className="w-5 h-5 mr-2 text-[#B5BFC8]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-gradient-to-r from-[#F0D3C7] to-[#F2E6D8] rounded-lg">
                  ...
                  <span className="text-lg font-bold text-[#B5BFC8]">
                    1,234
                  </span>
                </div>
