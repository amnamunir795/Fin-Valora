  ...
  return (
    <div className="min-h-screen bg-mist py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Content */}
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-void/20">
          <div className="prose prose-lg max-w-none">
            <p className="text-void mb-6">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-void mb-4">
                1. Information We Collect
              </h2>
              <p className="text-void mb-4">
                We collect information that you provide directly to us,
                including:
              </p>
              <ul className="list-disc list-inside text-void space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-void mb-4">You have the right to:</p>
              <ul className="list-disc list-inside text-void space-y-2 ml-4">
        ...
        <div className="mt-8">
          <div className="bg-white rounded-xl shadow-lg p-6 border border-void/20">
              ...
              <button
                ...
                className={`inline-flex items-center justify-center px-6 py-3 font-semibold rounded-xl focus:outline-none focus:ring-2 focus:ring-teal transition-all duration-200 shadow-lg ${
                  accepted
                    ...
                    : "bg-void/20 text-void/40 cursor-not-allowed"
                }`}
              >
                <svg
                  className="w-5 h-5 mr-2"
