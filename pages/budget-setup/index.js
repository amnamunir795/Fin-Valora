...
export default function BudgetSetup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrors({ submit: result.message || 'Failed to setup budget. Please try again.' });
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F2E6D8] via-[#F0D3C7] to-[#E8C5B5] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-2xl w-full bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl drop-shadow-2xl border border-white/20 p-8 relative z-10 transform hover:scale-105 transition-all duration-300" style={{boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)'}}>
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#B5BFC8] to-[#9FAAB5] rounded-full mb-6 shadow-lg drop-shadow-lg" style={{boxShadow: '0 10px 25px -3px rgba(181, 191, 200, 0.4), 0 4px 6px -2px rgba(181, 191, 200, 0.2)'}}>
          ...
          <div className="bg-gradient-to-r from-[#F2E6D8]/50 to-[#F0D3C7]/50 rounded-xl p-6 mb-6 shadow-md">
            <p className="text-gray-700 text-lg leading-relaxed">
              <span className="font-semibold text-[#B5BFC8]">Welcome to your Budget Settings</span> — the best place to plan your money smartly every month!
            </p>
          </div>
          
          <div className="text-left bg-white/50 rounded-xl p-6 mb-6 shadow-sm">
            <h2 className="text-xl font-semibold text-[#B5BFC8] mb-4">Here's what you can do:</h2>
            <div className="space-y-3 text-gray-700">
              <div className="flex items-start">
                <span className="text-2xl mr-3">💵</span>
                <div>
                  <span className="font-semibold">Add Your Monthly Income</span> — Enter your total income for this month. You only need to do this once.
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-2xl mr-3">📅</span>
                <div>
                  <span className="font-semibold">Pick a Start Date</span> — Choose when your budget should begin, like the first day of the month.
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-2xl mr-3">💸</span>
                <div>
                  <span className="font-semibold">Set Your Spending Limit</span> — Decide how much you want to spend so you can stay on track.
                </div>
              </div>
              <div className="flex items-start">
                <span className="text-2xl mr-3">🏦</span>
                <div>
                  <span className="font-semibold">Add a Saving Goal</span> — Write down how much you'd love to save by the end of the month.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#B5BFC8]/10 to-[#9FAAB5]/10 rounded-xl p-4 mb-6">
            <p className="text-gray-600 text-sm">
              Once you save your plan, you'll be able to see how your money is being used — what's spent, what's left, and how close you are to your savings goal.
            </p>
            <p className="text-[#B5BFC8] font-semibold mt-2">
              ✨ Stay organized, spend wisely, and watch your savings grow — one month at a time!
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="monthlyIncome" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="spendingLimit" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                <svg className="w-4 h-4 mr-2 text-[#B5BFC8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <label htmlFor="savingGoal" className="block text-sm font-semibold text-gray-700 mb-2 flex items-center">
                <svg className="w-4 h-4 mr-2 text-[#B5BFC8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
